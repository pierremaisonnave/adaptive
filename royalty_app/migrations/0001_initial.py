# Generated by Django 3.2 on 2021-07-14 12:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', django_resized.forms.ResizedImageField(crop=None, default='royalty_app/static/default.png', force_format=None, keep_meta=True, quality=0, size=[150, 100], upload_to='media/profile_picture/')),
